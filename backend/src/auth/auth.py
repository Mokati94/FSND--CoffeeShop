...
AUTH0_DOMAIN = 'mafusifsndprojects.eu.auth0.com'
ALGORITHMS = ['RS256']
API_AUDIENCE = 'udacityfs'
...
def check_permissions(permission, payload):
    """ Checks to see if permissions are included in the payload. 
    Raises AuthError if not, returns true otherwise. 
    """
...
def verify_decode_jwt(token):
    """ Verifies JWT using Auth0 /.well-known/jkwks.json.
